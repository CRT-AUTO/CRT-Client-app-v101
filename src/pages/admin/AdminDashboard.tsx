              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="flex items-baseline">
                    ...
                    <div className="ml-2 text-sm font-medium text-gray-500">
                      ({(totalConversations / Math.max(1, totalUsers)).toFixed(1)} avg/user)
                    </div>
                  </dd>
                </dl>
              </div>
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="flex items-baseline">
                    ...
                    <div className="ml-2 text-sm font-medium text-gray-500">
                      ({(totalMessages / Math.max(1, totalConversations)).toFixed(1)} avg/conv)
                    </div>
                  </dd>
                </dl>
              </div>
            ...
            <div className="border rounded-lg p-5">
              ...
              <div className="relative pt-1">
                <div className="overflow-hidden h-2 text-xs flex rounded bg-blue-200">
                  <div 
                    style={{ width: `${(usersWithFacebook / totalUsers) * 100}%` }} 
                    className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-600">
                  </div>
                </div>
              </div>
              <p className="mt-2 text-xs text-gray-500">
                {((usersWithFacebook / totalUsers) * 100).toFixed(0)}% of users have Facebook connected
              </p>
            </div>
            ...
            <div className="border rounded-lg p-5">
              ...
              <div className="relative pt-1">
                <div className="overflow-hidden h-2 text-xs flex rounded bg-pink-200">
                  <div 
                    style={{ width: `${(usersWithInstagram / totalUsers) * 100}%` }} 
                    className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-pink-600">
                  </div>
                </div>
              </div>
              <p className="mt-2 text-xs text-gray-500">
                {((usersWithInstagram / totalUsers) * 100).toFixed(0)}% of users have Instagram connected
              </p>
            </div>
            ...
            <div className="border rounded-lg p-5">
              ...
              <div className="relative pt-1">
                <div className="overflow-hidden h-2 text-xs flex rounded bg-indigo-200">
                  <div 
                    style={{ width: `${(usersWithVoiceflow / totalUsers) * 100}%` }} 
                    className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-indigo-600">
                  </div>
                </div>
              </div>
              <p className="mt-2 text-xs text-gray-500">
                {((usersWithVoiceflow / totalUsers) * 100).toFixed(0)}% of users have Voiceflow configured
              </p>
            </div>
            ...
            <div className="border rounded-lg p-5">
              ...
              <div className="relative pt-1">
                <div className="overflow-hidden h-2 text-xs flex rounded bg-green-200">
                  <div 
                    style={{ width: `${(usersWithWebhook / totalUsers) * 100}%` }} 
                    className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-green-600">
                  </div>
                </div>
              </div>
              <p className="mt-2 text-xs text-gray-500">
                {((usersWithWebhook / totalUsers) * 100).toFixed(0)}% of users have webhooks configured
              </p>
            </div>
          </div>
        </div>
